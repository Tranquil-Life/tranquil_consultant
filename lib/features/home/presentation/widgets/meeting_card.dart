...
class MeetingCard extends StatelessWidget {
          ...
          Container(
              ...
              child: Center(
                child: UserAvatar(
                  ...
                  source: meeting.client.usesBitmoji!
  ...
  Row topRow() {
    ...
    //ONGOING
    else if (meeting.endAt.isAfter(now) && meeting.startAt.isBefore(now) ||
        meeting.startAt == now) {
      return Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
