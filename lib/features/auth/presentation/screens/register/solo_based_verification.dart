...
class _SoloBasedVerificationState extends State<SoloBasedVerification> {
          ...
          child: Column(
            ...
            children: [
              ...
              PinCodeTextField(
                ...
                onChanged: (value) {
                  if (value.isEmpty) {
                    verificationController.isConfirmed = null;
                    setState(() {});
                  }
                },
  ...
  verificationState() {
    if (verificationController.isConfirmed?.value != null &&
        verificationController.isConfirmed!.value) {
      return true;
    } else if (verificationController.isConfirmed?.value != null &&
        !verificationController.isConfirmed!.value) {
      return false;
    } else {
      return null;
