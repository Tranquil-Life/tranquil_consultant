      ...
      children: [
          ...
          children: [
            const Wrap(
              ...
              children: [
                ...
                Icon(Icons.download_for_offline, color: ColorPalette.green)
              ],
            ),
            Wrap(
              direction: Axis.horizontal,
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Icon(Icons.arrow_drop_down_rounded,
                      size: 50, color: ColorPalette.green),
                )
              ],
            ),
          ],
        ...
        transactions.isEmpty
            ? Container(
                ...
                child: Text("No transactions yet", style: TextStyle(fontSize: AppFonts.defaultSize),),
              )
            : ListView.builder(
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  "${isCredit == false ? "-" : ""}$amount",
                                  style:
                                      TextStyle(fontSize: AppFonts.defaultSize),
                                ),
                              ),
                            ),
                            Align(
                            ...
                            Align(
                              ...
                              child: Container(
                                padding: EdgeInsets.only(top: 8),
                                child: Text(updatedAt.formattedTime,
                                    style: TextStyle(
                                        fontSize: AppFonts.defaultSize)),
                              ),
                            ),
